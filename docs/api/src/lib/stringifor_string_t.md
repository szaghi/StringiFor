...
```mermaid
graph LR
  stringifor_string_t["stringifor_string_t"] --> iso_fortran_env["iso_fortran_env"]
```
...
| `UPPER_ALPHABET` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=26) | parameter | Upper case alphabet. |
| `LOWER_ALPHABET` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=26) | parameter | Lower case alphabet. |
| `SPACE` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | parameter | Space character. |
| `TAB` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | parameter | Tab character. |
| `UIX_DIR_SEP` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | parameter | Unix/Linux directories separator (/). |
| `BACKSLASH` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | parameter | Backslash character. |
...
| Name | Type | Attributes | Description |
|------|------|------------|-------------|
| `raw` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=:) | allocatable | Raw data. |
...
**Module procedures**: [`glob_character`](/api/src/lib/stringifor_string_t#glob-character), [`glob_string`](/api/src/lib/stringifor_string_t#glob-string)

### strjoin

**Module procedures**: [`strjoin_strings`](/api/src/lib/stringifor_string_t#strjoin-strings), [`strjoin_characters`](/api/src/lib/stringifor_string_t#strjoin-characters), [`strjoin_strings_array`](/api/src/lib/stringifor_string_t#strjoin-strings-array), [`strjoin_characters_array`](/api/src/lib/stringifor_string_t#strjoin-characters-array)

### adjustl

Builtin adjustl overloading.

**Module procedures**: [`sadjustl_character`](/api/src/lib/stringifor_string_t#sadjustl-character)

### adjustr

Builtin adjustr overloading.

**Module procedures**: [`sadjustr_character`](/api/src/lib/stringifor_string_t#sadjustr-character)

### count

Builtin count overloading.

**Module procedures**: [`count_substring`](/api/src/lib/stringifor_string_t#count-substring)

### index

Builtin index overloading.

**Module procedures**: [`sindex_string_string`](/api/src/lib/stringifor_string_t#sindex-string-string), [`sindex_string_character`](/api/src/lib/stringifor_string_t#sindex-string-character), [`sindex_character_string`](/api/src/lib/stringifor_string_t#sindex-character-string)

### len_trim

Builtin len_trim overloading.

**Module procedures**: [`slen_trim`](/api/src/lib/stringifor_string_t#slen-trim)

### repeat

Builtin repeat overloading.

**Module procedures**: [`srepeat_string_string`](/api/src/lib/stringifor_string_t#srepeat-string-string)

### scan

Builtin scan overloading.

**Module procedures**: [`sscan_string_string`](/api/src/lib/stringifor_string_t#sscan-string-string), [`sscan_string_character`](/api/src/lib/stringifor_string_t#sscan-string-character), [`sscan_character_string`](/api/src/lib/stringifor_string_t#sscan-character-string)

### trim

Builtin trim overloading.

**Module procedures**: [`strim`](/api/src/lib/stringifor_string_t#strim)

### verify

Builtin verify overloading.

**Module procedures**: [`sverify_string_string`](/api/src/lib/stringifor_string_t#sverify-string-string), [`sverify_string_character`](/api/src/lib/stringifor_string_t#sverify-string-character), [`sverify_character_string`](/api/src/lib/stringifor_string_t#sverify-character-string)
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | inout |  | The string. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
...
```mermaid
flowchart TD
  glob_character["glob_character"] --> chars["chars"]
  glob_character["glob_character"] --> glob["glob"]
  style glob_character fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `pattern` | character(len=*) | in |  | Given pattern. |
| `list` | type([string](/api/src/lib/stringifor_string_t#string)) | out | allocatable | List of matching pathnames. |
...
flowchart TD
  ...
  glob_string["glob_string"] --> split["split"]
  glob_string["glob_string"] --> tempname["tempname"]
  style glob_string fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  ...
  read_lines["read_lines"] --> read_line["read_line"]
  read_line["read_line"] --> chars["chars"]
  read_line["read_line"] --> upper["upper"]
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `tokens` | type([string](/api/src/lib/stringifor_string_t#string)) | out | allocatable | Tokens substring. |
| `sep` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Separator. |
...
```mermaid
flowchart TD
  camelcase["camelcase"] --> split["split"]
  glob_string["glob_string"] --> split["split"]
  snakecase["snakecase"] --> split["split"]
  split_chunked["split_chunked"] --> split["split"]
  startcase["startcase"] --> split["split"]
  write_lines["write_lines"] --> split["split"]
  split["split"] --> partition["partition"]
  split["split"] --> unique["unique"]
  style split fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  split_chunked["split_chunked"] --> end_with["end_with"]
  split_chunked["split_chunked"] --> split["split"]
  split_chunked["split_chunked"] --> split_last_token["split_last_token"]
  split_chunked["split_chunked"] --> start_with["start_with"]
  style split_chunked fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  ...
  write_lines["write_lines"] --> write_line["write_line"]
  write_line["write_line"] --> chars["chars"]
  write_line["write_line"] --> end_with["end_with"]
  write_line["write_line"] --> upper["upper"]
  style write_line fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([string](/api/src/lib/stringifor_string_t#string)) | inout |  | Left hand side. |
| `rhs` | type([string](/api/src/lib/stringifor_string_t#string)) | in |  | Right hand side. |
...
|------|------|--------|------------|-------------|
| `lhs` | class([string](/api/src/lib/stringifor_string_t#string)) | inout |  | Left hand side. |
| `rhs` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `dtv` | class([string](/api/src/lib/stringifor_string_t#string)) | inout |  | The string. |
| `unit` | integer | in |  | Logical unit. |
...
```mermaid
flowchart TD
  read_formatted["read_formatted"] --> get_next_non_blank_character_any_record["get_next_non_blank_character_any_record"]
  read_formatted["read_formatted"] --> read_delimited["read_delimited"]
  read_formatted["read_formatted"] --> read_undelimited_listdirected["read_undelimited_listdirected"]
  style read_formatted fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| `dtv` | class([string](/api/src/lib/stringifor_string_t#string)) | inout |  | The string. |
| `unit` | integer | in |  | Logical unit. |
| `delim` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | in |  | String delimiter. |
| `iostat` | integer | out |  | IO status code. |
| `iomsg` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | inout |  | IO status message. |
...
flowchart TD
  read_formatted["read_formatted"] --> read_delimited["read_delimited"]
  style read_delimited fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  read_formatted["read_formatted"] --> read_undelimited_listdirected["read_undelimited_listdirected"]
  read_undelimited_listdirected["read_undelimited_listdirected"] --> get_decimal_mode["get_decimal_mode"]
  read_undelimited_listdirected["read_undelimited_listdirected"] --> read_undelimited["read_undelimited"]
  style read_undelimited_listdirected fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| `dtv` | class([string](/api/src/lib/stringifor_string_t#string)) | inout |  | The string. |
| `unit` | integer | in |  | Logical unit. |
| `terminators` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Characters that are considered to terminate the string. |
| `iostat` | integer | out |  | IO status code. |
| `iomsg` | character(len=*) | inout |  | IO status message. |
...
flowchart TD
  read_undelimited_listdirected["read_undelimited_listdirected"] --> read_undelimited["read_undelimited"]
  style read_undelimited fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `dtv` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `unit` | integer | in |  | Logical unit. |
| `iotype` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Edit descriptor. |
| `v_list` | integer | in |  | Edit descriptor list. |
| `iostat` | integer | out |  | IO status code. |
| `iomsg` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | inout |  | IO status message. |
...
| `delim` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | out |  | Represents the value of the DELIM mode. |
...
|------|------|--------|------------|-------------|
| `unit` | integer | in |  | Logical unit. |
| `ch` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | out |  | The non-blank character read. Not valid if IOSTAT is non-zero. |
| `iostat` | integer | out |  | IO status code. |
| `iomsg` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | inout |  | IO status message. |
...
```mermaid
flowchart TD
  get_next_non_blank_character_any_record["get_next_non_blank_character_any_record"] --> get_next_non_blank_character_this_record["get_next_non_blank_character_this_record"]
  style get_next_non_blank_character_this_record fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  read_formatted["read_formatted"] --> get_next_non_blank_character_any_record["get_next_non_blank_character_any_record"]
  get_next_non_blank_character_any_record["get_next_non_blank_character_any_record"] --> get_next_non_blank_character_this_record["get_next_non_blank_character_this_record"]
  style get_next_non_blank_character_any_record fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  read_undelimited_listdirected["read_undelimited_listdirected"] --> get_decimal_mode["get_decimal_mode"]
  style get_decimal_mode fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
**Returns**: type([string](/api/src/lib/stringifor_string_t#string))
...
**Returns**: character(kind=[CK](/api/src/lib/stringifor_string_t), len=:)
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `s` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | String. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `s` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | String. |
| `substring` | type([string](/api/src/lib/stringifor_string_t#string)) | in |  | Searched substring. |
...
|------|------|--------|------------|-------------|
| `s` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | String. |
| `set` | type([string](/api/src/lib/stringifor_string_t#string)) | in |  | Searched set. |
| `back` | logical | in | optional | Start of the last occurrence rather than the first. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `substring` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Searched substring. |
| `back` | logical | in | optional | Start of the last occurrence rather than the first. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | String to be repeated. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `rstring` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | String to be repeated. |
| `ncopies` | integer | in |  | Number of string copies. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `set` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Searched set. |
| `back` | logical | in | optional | Start of the last occurrence rather than the first. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `sep` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Directory separator. |
...
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `sep` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Directory separator. |
| `extension` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | File extension. |
...
```mermaid
flowchart TD
  camelcase["camelcase"] --> capitalize["capitalize"]
  camelcase["camelcase"] --> join["join"]
  camelcase["camelcase"] --> split["split"]
  style camelcase fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  camelcase["camelcase"] --> capitalize["capitalize"]
  startcase["startcase"] --> capitalize["capitalize"]
  capitalize["capitalize"] --> lower["lower"]
  style capitalize fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  colorize_str["colorize_str"] --> chars["chars"]
  glob_character["glob_character"] --> chars["chars"]
  read_file["read_file"] --> chars["chars"]
  read_file["read_file"] --> chars["chars"]
  read_line["read_line"] --> chars["chars"]
  ...
  write_file["write_file"] --> chars["chars"]
  write_line["write_line"] --> chars["chars"]
  style chars fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  colorize_str["colorize_str"] --> chars["chars"]
  style colorize_str fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `codec` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Encoding codec. |

**Call graph**

```mermaid
flowchart TD
  decode["decode"] --> strip["strip"]
  decode["decode"] --> upper["upper"]
  style decode fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  encode["encode"] --> upper["upper"]
  style encode fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `to_escape` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | in |  | Character to be escaped. |
| `esc` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Character used to escape. |
...
| `filling_char` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | in | optional | Filling character (default "0"). |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `substring` | type([string](/api/src/lib/stringifor_string_t#string)) | in |  | Substring. |
| `pos` | integer | in |  | Position from which insert substring. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `array` | type([string](/api/src/lib/stringifor_string_t#string)) | in |  | Array to be joined. |
| `sep` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Separator. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `array` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Array to be joined. |
| `sep` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Separator. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `array` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | Array to be joined. |
| `sep` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Separator. |
...
```mermaid
flowchart TD
  strjoin_strings_array["strjoin_strings_array"] --> strjoin_strings["strjoin_strings"]
  style strjoin_strings fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  strjoin_characters_array["strjoin_characters_array"] --> strjoin_characters["strjoin_characters"]
  style strjoin_characters fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  strjoin_strings_array["strjoin_strings_array"] --> strjoin_strings["strjoin_strings"]
  style strjoin_strings_array fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  strjoin_characters_array["strjoin_characters_array"] --> strjoin_characters["strjoin_characters"]
  style strjoin_characters_array fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  split["split"] --> partition["partition"]
  style partition fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `old` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Old substring. |
| `new` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | New substring. |
...
```mermaid
flowchart TD
  unique["unique"] --> replace["replace"]
  replace["replace"] --> replace_one_occurrence["replace_one_occurrence"]
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `tag_start` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Start tag. |
| `tag_end` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | End tag. |
| `in_string` | type([string](/api/src/lib/stringifor_string_t#string)) | in | optional | Search into this string. |
| `in_character` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Search into this character string. |
...
```mermaid
flowchart TD
  snakecase["snakecase"] --> join["join"]
  snakecase["snakecase"] --> lower["lower"]
  snakecase["snakecase"] --> split["split"]
  style snakecase fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  startcase["startcase"] --> capitalize["capitalize"]
  startcase["startcase"] --> join["join"]
  startcase["startcase"] --> split["split"]
  style startcase fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  decode["decode"] --> strip["strip"]
  style strip fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  glob_string["glob_string"] --> tempname["tempname"]
  style tempname fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_integer_I1P["to_integer_I1P"] --> is_integer["is_integer"]
  style to_integer_I1P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_integer_I2P["to_integer_I2P"] --> is_integer["is_integer"]
  style to_integer_I2P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_integer_I4P["to_integer_I4P"] --> is_integer["is_integer"]
  style to_integer_I4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_integer_I8P["to_integer_I8P"] --> is_integer["is_integer"]
  style to_integer_I8P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_real_R4P["to_real_R4P"] --> is_real["is_real"]
  style to_real_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_real_R8P["to_real_R8P"] --> is_real["is_real"]
  style to_real_R8P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  to_real_R16P["to_real_R16P"] --> is_real["is_real"]
  style to_real_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `to_unescape` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=1) | in |  | Character to be unescaped. |
| `unesc` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Character used to unescape. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `substring` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in | optional | Substring which multiple occurences must be reduced to one. |
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `suffix` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Searched suffix. |
...
flowchart TD
  split_chunked["split_chunked"] --> end_with["end_with"]
  write_line["write_line"] --> end_with["end_with"]
  style end_with fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  is_number["is_number"] --> is_integer["is_integer"]
  to_integer_I1P["to_integer_I1P"] --> is_integer["is_integer"]
  to_integer_I2P["to_integer_I2P"] --> is_integer["is_integer"]
  to_integer_I4P["to_integer_I4P"] --> is_integer["is_integer"]
  to_integer_I8P["to_integer_I8P"] --> is_integer["is_integer"]
  style is_integer fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  is_number["is_number"] --> is_integer["is_integer"]
  is_number["is_number"] --> is_real["is_real"]
  style is_number fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  ...
  to_real_R4P["to_real_R4P"] --> is_real["is_real"]
  to_real_R8P["to_real_R8P"] --> is_real["is_real"]
  style is_real fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | The string. |
| `prefix` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Searched prefix. |
| `start` | integer | in | optional | Start position into the string. |
| `end` | integer | in | optional | End position into the string. |
...
flowchart TD
  split_chunked["split_chunked"] --> start_with["start_with"]
  style start_with fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | Left hand side. |
| `rhs` | type([string](/api/src/lib/stringifor_string_t#string)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | character(kind=[CK](/api/src/lib/stringifor_string_t), len=*) | in |  | Left hand side. |
| `rhs` | class([string](/api/src/lib/stringifor_string_t#string)) | in |  | Right hand side. |
...
Return a string with the first occurrence of substring old replaced by new.
 ...
 @note The doctest is not necessary, this being tested by [replace](/api/src/lib/stringifor_string_t#replace).
...
flowchart TD
  replace["replace"] --> replace_one_occurrence["replace_one_occurrence"]
  style replace_one_occurrence fill:#3e63dd,stroke:#99b,stroke-width:2px
```
